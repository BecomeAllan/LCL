%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Relatorio do 1o experimento - Grupo B2 / Turma T2
% ATENCAO: substitua as medicoes simuladas por registros
% reais antes da entrega, quando aplicavel.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
the expected truth tables. The simulated measurements must be replaced by actual
...
as tabelas verdade esperadas. As medições simuladas devem ser substituídas pelos
...
O pré-projeto utilizado como referência para a preparação da atividade está disponível em
\href{https://drive.google.com/file/d/1xrnp6LJTi8HymDi-AswCgr1Z5TA05lby/view?usp=drivesdk}{Pré-projeto - Google Drive}.

\section{Procedimentos e Resultados}
\label{sec:procedimentos}

\textbf{Aviso:} as medições apresentadas nesta versão são simuladas
e servem apenas para estruturar e testar o documento. Elas não constituem
...
com o comportamento lógico esperado. O registro da execução prática está
...
O registro em vídeo do teste das portas AND e OR pode ser acessado em
\href{https://drive.google.com/file/d/1eVGJeG3TJrlJT-N0to8uFadk5Nuf4HiG/view?usp=drivesdk}{Vídeo do experimento - teste AND/OR}.
...
O registro em vídeo dessa montagem pode ser acessado em
\href{https://drive.google.com/file/d/1Nlw_ZkjOlQRgta15OaWYJaThIjsZHRao/view?usp=drivesdk}{Vídeo do experimento - AND real}.
...
devem ser substituídas pelos registros obtidos no laboratório.
...
\begin{enumerate}
    ...
    \end{tabular}
    \end{table}
    \item b,d,a,c (De cima para baixo)
\end{enumerate}
