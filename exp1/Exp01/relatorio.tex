...
Foram utlizados os seguintes materiais e equipamentos:
...
com o comportamento lógico esperado. O circuito real foi montado assim (Dada a pinagem idêntica de ambos os CIs, não é necessário mudar o posicionamento dos fios, de modo que a imagem vale para as duas funções lógicas):

\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{figcircuito1.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
        1 & 1 & 4,95 & 4,90 & 4,94 & 4,96 \\
        \hline
    \end{tabular}
\end{table}

Os dados simulados reproduzem a tabela verdade da operação AND. Tensões 0,00V foram geradas quando ao menos uma entrada estava em nível baixo.
Quando A e B estavam simultaneamente em nível alto, as saídas ficaram entre
4,90 V e 4,96 V. O vídeo da simulação pode ser acessado \href{https://drive.google.com/file/d/1Nlw_ZkjOlQRgta15OaWYJaThIjsZHRao/view?usp=drive_link}{aqui}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        0 & 0 & 0,00 & 0,00 & 0,00 & 0,00 \\
        \hline
        0 & 1 & 4,87 & 4,80 & 4,86 & 4,87 \\
        \hline
        1 & 0 & 4,87 & 4,88 & 4,86 & 4,87 \\
        \hline
        1 & 1 & 4,88 & 4,81 & 4,87 & 4,88 \\
        \hline
    \end{tabular}
\end{table}
...
nível lógico alto. O vídeo do experimento pode ser acessado \href{https://drive.google.com/file/d/1eVGJeG3TJrlJT-N0to8uFadk5Nuf4HiG/view?usp=drive_link}{aqui}.
...
AND e ilustra a aplicação da lei de De Morgan. O vídeo do experimento pode ser acessado \href{https://drive.google.com/file/d/1xrnp6LJTi8HymDi-AswCgr1Z5TA05lby/view?usp=drive_link}{aqui}.
...
esperada e demonstrou a aplicação prática da lei de De Morgan.
