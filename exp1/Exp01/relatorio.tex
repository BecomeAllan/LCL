...
tensão, interpretados como valores lógicos 0 e 1. As operações fundamentais da
...
As respostas da autoavaliação devem ser preenchidas pelo grupo após a discussão
das questões propostas no roteiro.
